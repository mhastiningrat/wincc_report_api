...
const exportExcel = async (req, res) => {
	try {
		...
		worksheet.getCell("B8").value = " "; // crew
		worksheet.getCell("E4").value = " "; // supv
		worksheet.getCell("E5").value = " "; // supv in
		worksheet.getCell("E6").value = " "; // supv out
		worksheet.getCell("E7").value = " "; // croom1
		worksheet.getCell("E8").value = " "; // croom2
		worksheet.getCell("E9").value = " "; // stacker1
		worksheet.getCell("E10").value = " "; // stacker2
		worksheet.getCell("H4").value = " "; // reclaimer1
		worksheet.getCell("H5").value = " "; // reclaimer2
		worksheet.getCell("H6").value = " "; // nsl
		worksheet.getCell("H7").value = " "; // nth do
		worksheet.getCell("H8").value = " "; // ssl
		worksheet.getCell("H9").value = " "; // sth do
		worksheet.getCell("H10").value = " "; // blf
		worksheet.getCell("K5").value = " "; // olc1 prima
		worksheet.getCell("K7").value = " "; // olc2 prima
		worksheet.getCell("L5").value = " "; // olc1 pinang
		worksheet.getCell("L7").value = " "; // olc2 pinang
		worksheet.getCell("M5").value = " "; // olc1 melawan
		worksheet.getCell("M7").value = " "; // olc2 melawan
		worksheet.getCell("N5").value = " "; // olc1 total
		worksheet.getCell("N7").value = " "; // olc2 total
		worksheet.getCell("N9").value = " "; // olc2 total
		worksheet.getCell("O6").value = " "; // coal reclaimer 1 vessel 1
		worksheet.getCell("P6").value = " "; // coal reclaimer 2 vessel 1
		worksheet.getCell("Q4").value = " "; // coal vessel 1 mv
		worksheet.getCell("Q6").value = " "; // coal stamler vessel 1
		worksheet.getCell("R6").value = " "; // coal trestle vessel 1

		worksheet.getCell("S6").value = " "; // coal reclaimer 1 vessel 2
		worksheet.getCell("T6").value = " "; // coal reclaimer 2 vessel 2
		worksheet.getCell("U4").value = " "; // coal vessel 2 mv
		worksheet.getCell("U6").value = " "; // coal stamler vessel 2
		worksheet.getCell("V6").value = " "; // coal trestle  vessel 2
		worksheet.getCell("S7").value = " "; // coal total blf
		worksheet.getCell("S9").value = " "; // coal coal shipped

		worksheet.getCell("W6").value = " "; // coal reclaimer 1 vessel 3
		worksheet.getCell("X6").value = " "; // coal reclaimer 2 vessel 3
		worksheet.getCell("Y4").value = " "; // coal vessel 3 mv
		worksheet.getCell("Y6").value = " "; // coal stamler vessel 3
		worksheet.getCell("Z6").value = " "; // coal trestle  vessel 3
		...
		await workbook.xlsx
			...
			.then(() => {
				res.download(
					`${direct}/COAL_TERMINAL_SUMMARY_REPORT_12_HOURS_SHIFT_PAGE_1_${datePrint}.xlsx`,
					`COAL_TERMINAL_SUMMARY_REPORT_12_HOURS_SHIFT_PAGE_1_${datePrint}.xlsx`,
					(err) => {
						if (err) {
							console.log(err);
						} else {
